...
>>(Александр Кириллов, технический директор компании Evrone)
...
Для просмотра источника информации:
перейти на [Git seminar](https://github.com/oleggolen/Seminar-13-12-2021)
