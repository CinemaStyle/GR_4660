...
3. Заходим на страницу с интересующим нас репозиторием и находим зеленую кнопку **Code**. Нажимаем, копируем строку. Предположим, строка выглядит как **https://github.com/**

4. В терминале в VS code вводим... Еще раз, убедились, что ваша папка не инициирована? Ок.
В терминале в VS code вводим *git clone* **https://github.com/**. 
Жмем Enter.
