...
Для отображения изменений в одной линии, используется команда **git log --oneline**
...
Чтобы выделить текст курсивом, необходимо обрамить его звездочками (*) или нижними подчеркиваниями (_). Например, *вот так* или _так_.
